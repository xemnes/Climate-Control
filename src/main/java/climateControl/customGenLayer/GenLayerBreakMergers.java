...
public class GenLayerBreakMergers extends GenLayerPack {
        ...
        for(int i2 = 0; i2 < par4; ++i2) {
            for(int j2 = 0; j2 < par3; ++j2) {
                ...
                if (isOceanic(k3)) {
                    ...
                    if (this.tooDifferent(up, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(left, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(right, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(down, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(upleft, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(downleft, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(upright, k3)) {
                        k3 = 0;
                    }

                    if (this.tooDifferent(downright, k3)) {
                        k3 = 0;
                    }
    ...
    boolean tooDifferent(int compare, int result) {
        return !isOceanic(compare) && !isOceanic(result) && (compare < result - 3 || compare > result + 3);
    }
}
